...
def my_parcorr(pc_sig, final_sig, tau_min, tau_max, var_names,i):
    ...
    tp.plot_graph(
        ...
        label_fontsize=15,
        network_lower_bound=0.05,
        show_colorbar=0
    );
    plt.suptitle("%s" % i, size=18, weight="semibold", verticalalignment="top", horizontalalignment="center")
    plt.savefig('/Users/pei/Dropbox (linweit)/ehrg/users/Pei/PJT/USA_FLU/codes/PCMCIres_state_%s.png' % i, dpi=500)
    plt.show()


dat0 = pd.read_csv("/Users/pei/Dropbox (linweit)/ehrg/users/Pei/PJT/USA_FLU/codes/usaflu_raw.csv", header=0, index_col=0)

states = ["Alaska", "Alabama", "Arkansas", "Arizona", "California", "Colorado", "Connecticut", "Delaware", "Georgia",
          "Hawaii", "Illinois", "Kentucky", "Louisiana", "Maryland", "Minnesota", "Missouri", "Montana", "New York",
